...
static const yytype_int16 yyrline[] =
{
     ...
     189,   193,   197,   205,   213,   221,   229,   229,   237,   237,
     245,   245,   252,   252,   259,   262,   263,   264,   270,   283,
     299,   322,   347,   351,   370,   375,   379,   380,   381,   385,
     390,   397,   401,   402,   405,   406,   411,   412,   415,   415,
     419,   433,   438,   439,   441,   448,   455,   456,   457,   459,
     461,   471,   484,   485,   486,   489,   493,   493,   494,   494,
     497,   498,   507,   522,   523,   525,   527,   529,   531,   531,
     544,   545,   546,   547,   548,   549,   552,   564,   566,   574,
     574,   582,   584,   585,   588,   589,   619,   621,   623,   625,
     633,   634,   636,   636,   646,   648,   648,   660,   660,   665,
     665
};
#endif
...
#line 197 "parser.y"
      ...
      check_operands(if_greater,(yyvsp[-2].ex),(yyvsp[0].ex));
...
#line 205 "parser.y"
      ...
      (yyval.ex)->trueList = newlist(nextquadlabel());
      (yyval.ex)->falseList = newlist(nextquadlabel() + 1);
      check_operands(if_greatereq,(yyvsp[-2].ex),(yyvsp[0].ex));
...
#line 213 "parser.y"
      ...
      (yyval.ex)->trueList = newlist(nextquadlabel());
      (yyval.ex)->falseList = newlist(nextquadlabel() + 1);
      check_operands(if_less,(yyvsp[-2].ex),(yyvsp[0].ex));
...
#line 221 "parser.y"
      ...
      (yyval.ex)->trueList = newlist(nextquadlabel());
      (yyval.ex)->falseList = newlist(nextquadlabel() + 1);
      check_operands(if_lesseq,(yyvsp[-2].ex),(yyvsp[0].ex));
...
#line 270 "parser.y"
  ...
  if ((yyvsp[0].ex)->type == tableitem_e) {
    ...
    emit(assign, (yyval.ex), (yyvsp[0].ex),NULL, 0, yylineno);
  }
}
#line 1799 "parser.c"
    break;
...
#line 283 "parser.y"
  ...
  if ((yyvsp[-1].ex)->type == tableitem_e) {
    ...
    emit(assign, (yyval.ex), (yyvsp[-1].ex), NULL, 0, yylineno);
...
#line 299 "parser.y"
  ...
  if ((yyvsp[0].ex)->type == tableitem_e) {
    ...
    emit(sub, (yyvsp[0].ex),(yyvsp[0].ex), newexpr_constnum(1), 0, yylineno);
    (yyval.ex) = create_expr(arithexpr_e, newtemp(symtable, lists, scope, yylineno), (yyvsp[0].ex), 0.0f, NULL, '\0');
    emit(assign, (yyval.ex), (yyvsp[0].ex),NULL, 0, yylineno);
  }
...
#line 322 "parser.y"
  ...
  if ((yyvsp[-1].ex)->type == tableitem_e) {
    ...
    emit(assign, (yyval.ex), (yyvsp[-1].ex), NULL, 0, yylineno);
    emit(sub, (yyvsp[-1].ex),(yyvsp[-1].ex), newexpr_constnum(1), 0, yylineno);
  }
...
#line 456 "parser.y"
                   { (yyvsp[-2].ex)->next = (yyvsp[0].ex);  (yyvsp[-2].ex) = manage_bool_expr((yyvsp[-2].ex),symtable,lists,scope,yylineno); (yyval.ex)=(yyvsp[-2].ex); }
#line 2100 "parser.c"
    break;
...
#line 525 "parser.y"
                { (yyval.int_val) = currscopeoffset(); if((yyvsp[0].statement_struct)) patchlist((yyvsp[0].statement_struct)->retList,nextquadlabel()); exitscopespace(); }
#line 2246 "parser.c"
    break;
...
#line 531 "parser.y"
  ...
  patchlabel((yyvsp[-7].symbol)->iaddress, nextquadlabel());
...
#line 567 "parser.y"
    { 
      (yyvsp[-1].ex) = manage_bool_expr((yyvsp[-1].ex),symtable,lists,scope,yylineno);
      emit(if_eq,NULL,(yyvsp[-1].ex),create_expr(constbool_e,NULL,NULL,0.0f,"",'1'),nextquadlabel()+2,yylineno);
...
#line 588 "parser.y"
                      { if_stmt--; patchlabel((yyvsp[-1].int_val),nextquadlabel()); (yyval.statement_struct)=(yyvsp[0].statement_struct); }
#line 2392 "parser.c"
    break;
...
#line 590 "parser.y"
      { 
        ...
        if((yyvsp[-2].statement_struct)){
          ...
          ret_statements = (yyvsp[-2].statement_struct)->retList;
        }
...
#line 636 "parser.y"
              ...
              emit(if_eq,NULL,(yyvsp[-1].ex),create_expr(constbool_e,NULL,NULL,0.0f,"",'1'),0,yylineno);
